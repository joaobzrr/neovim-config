  ...
  mellifluous = {
    ...
    color_overrides = {
      dark = {
        colors = function(_)
          ...
          local green = color.new_from_hsl { h = 130, s = 30, l = 70 } -- Custom warm green tint
          return {
            strings = green,
            green = green,
          }
    ...
    highlight_overrides = {
      dark = function(hl, colors)
        hl.set('MiniPickNormal', { bg = colors.bg }) -- Match background with theme
        hl.set('MiniPickBorder', { fg = colors.bg4 }) -- Subtle border
      end,
    },
  },
  styles = {
